...
int main()
{
    ...
    cout << "1) Ìàòðèöà ñíà÷àëà: " << endl << setprecision(7);
    OutputMatrix(Matrix, B, n);
    //Âíèççççç
    Gauss(Matrix, B, n);
    cout << "Ìàòðèöà ïîñëå: " << endl;
    OutputMatrix(Matrix, B, n);
    //Ââåðõõõõ
    ...
    cout << "Âåêòîð íåâÿçêè :" << setw(10) << endl;
    for (int i = 0; i < n; i++)
    ...
    cout << setw(-10) << endl << "2) ÍÎÐÌÀ: " << norm << endl;
    ...
    cout << endl << "3) ÎÒÍÎÑÈÒÅËÜÍÀß ÏÎÃÐÅØÍÎÑÒÜ: " << deltamax << endl;
